...
LRESULT CALLBACK at_keyboard_proc(int code, WPARAM wParam, LPARAM lParam);
LRESULT CALLBACK at_foreground_idle_proc(int code, WPARAM wParam, LPARAM lParam);

HANDLE at_CreateFileW(LPCWSTR lpFileName, DWORD dwDesiredAccess, DWORD dwShareMode,
    LPSECURITY_ATTRIBUTES lpSecurityAttributes, DWORD dwCreationDisposition, DWORD dwFlagsAndAttributes, HANDLE hTemplateFile);
BOOL at_MoveFileExW(LPCWSTR lpExistingFileName, LPCWSTR lpNewFileName, DWORD dwFlags);
BOOL at_DeleteFileW(LPCWSTR lpFileName);

HANDLE at_FindFirstFileW(LPCWSTR lpFileName, LPWIN32_FIND_DATAW lpFindFileData);
DWORD at_GetFileAttributesW(LPCWSTR lpFileName);
...
HRESULT at_CreateDXGIFactory1(REFIID riid, void **ppFactory);
HRESULT at_CreateSwapChain(IDXGIFactory1 *pFactory, IUnknown *pDevice, DXGI_SWAP_CHAIN_DESC *pDesc, IDXGISwapChain **ppSwapChain);
HRESULT at_Present(IDXGISwapChain *swapChain, UINT SyncInterval, UINT Flags);
...
DWORD at_XInputGetState(DWORD dwUserIndex, XINPUT_STATE *pState);
HRESULT at_CreateDevice(IDirectInput8 *self, REFGUID rguid, LPDIRECTINPUTDEVICE * lplpDirectInputDevice, LPUNKNOWN pUnkOuter);
HRESULT at_GetDeviceStateKeyboard(IDirectInputDevice8 *self, DWORD cbData, LPVOID lpvData);
HRESULT at_GetDeviceStateGamepad(IDirectInputDevice8 *self, DWORD cbData, LPVOID lpvData);
//HRESULT at_GetDeviceData(IDirectInputDevice8 *self, DWORD cbObjectData, LPDIDEVICEOBJECTDATA rgdod, LPDWORD pdwInOut, DWORD dwFlags);
//HRESULT at_Poll(IDirectInputDevice8 *self);
map<BYTE**, BYTE*> _vtables;

BOOL at_device_enum_callback(LPCDIDEVICEINSTANCE lppdi, LPVOID pvRef);
BOOL at_device_enum_callback(LPCDIDEVICEINSTANCE lppdi, LPVOID pvRef);
BOOL at_object_enum_callback(LPCDIDEVICEOBJECTINSTANCE lpddoi, LPVOID pvRef);
...
/* similar to XINPUT_STATE, but with values adjusted for at use */
struct xi_state_t {
    BYTE buttons[10];
    BYTE left_trigger;
    BYTE right_trigger;
...
extern "C" void at_get_size(char *filename, struct FILE_INFO *fi);

extern "C" BOOL at_read_file_hk(
    HANDLE       hFile,
    LPVOID       lpBuffer,
    DWORD        nNumberOfBytesToRead,
    LPDWORD      lpNumberOfBytesRead,
...
extern "C" void at_get_size_hk();

extern "C" void at_extend_cpk_hk();

extern "C" void at_mem_copy(BYTE *dst, LONGLONG dst_len, BYTE *src, LONGLONG src_len, BYTE **rsp);

extern "C" void at_mem_copy_hk();

extern "C" void at_lookup_file(LONGLONG p1, LONGLONG p2, char *filename);

extern "C" void at_lookup_file_hk();

extern "C" void at_set_team_id(DWORD *dest, TEAM_INFO_STRUCT *team_info, DWORD offset);
...
extern "C" DWORD at_trophy_check(DWORD tournament_id);

extern "C" DWORD at_trophy_check_hk(DWORD tournament_id);

extern "C" DWORD at_trophy_check2_hk(DWORD tournament_id);

extern "C" void at_context_reset();

extern "C" void at_context_reset_hk();

extern "C" void at_free_select_hk();

extern "C" void at_free_select(BYTE *controller_restriction);

extern "C" void at_trophy_table(TROPHY_TABLE_ENTRY *tt);

extern "C" void at_trophy_table_hk();

extern "C" char* at_ball_name(char *ball_name);

extern "C" void at_ball_name_hk();

extern "C" char* at_stadium_name(STAD_INFO_STRUCT *stad_info, LONGLONG rdx, LONGLONG ptr, SCHEDULE_ENTRY *se);

extern "C" void at_stadium_name_hk();

extern "C" STAD_INFO_STRUCT* at_def_stadium_name(DWORD stadium_id);

extern "C" void at_def_stadium_name_hk();

extern "C" void at_set_stadium_choice(MATCH_INFO_STRUCT *mi, WORD stadium_id);

extern "C" void at_set_stadium_choice_hk();

extern "C" void at_check_kit_choice(MATCH_INFO_STRUCT *mi, DWORD home_or_away);

extern "C" void at_check_kit_choice_hk();

extern "C" DWORD at_data_ready(FILE_LOAD_INFO *fli);

extern "C" void at_data_ready_hk();

extern "C" void at_kit_status(KIT_STATUS_INFO *ksi, TASK_UNIFORM_IMPL *tu_impl);

extern "C" void at_kit_status_hk();

extern "C" void at_set_team_for_kits(KIT_STATUS_INFO *ksi, DWORD team_id_encoded, LONGLONG r8, DWORD *which);

extern "C" void at_set_team_for_kits_hk();

extern "C" void at_clear_team_for_kits(KIT_STATUS_INFO *ksi, DWORD *which);

extern "C" void at_clear_team_for_kits_hk();

extern "C" BYTE* at_loaded_uniparam(BYTE *uniparam);

extern "C" void at_loaded_uniparam_hk();

extern "C" void at_copy_clock_hk();

extern "C" void at_clear_sc(SCOREBOARD_INFO *sci);

extern "C" void at_clear_sc_hk();

extern "C" void at_set_edit_team_id_hk();

extern "C" void at_set_edit_team_id(DWORD team_id_encoded);

extern "C" void at_custom_event_rbx_hk();

extern "C" void at_custom_event(uint16_t event_id, REGISTERS *regs);

extern "C" void at_goal_scored_hk();

extern "C" void at_goal_scored(DWORD player_id, DWORD player_offset, DWORD is_away, BYTE* player_info);
...
unordered_map<string,uint16_t> _custom_event_ids;
uint16_t _next_custom_event(1);
...
bool init_paths() {
    ...
    // prep at dir
    memset(at_dir, 0, sizeof(at_dir));
    wcscpy(at_dir, dll_log);
    p = wcsrchr(at_dir, L'\\');
    *(p+1) = L'\0';
...
static int at_match_get_stats(lua_State *L) {
...
{
    config = new config_t(L"at", dll_ini);
...
static bool is_at(wchar_t* name)
{
    wchar_t *filename = wcsrchr(name, L'\\');
    if (filename) {
        if (wcsicmp(filename, L"\\AT.exe") == 0) {
            return true;
        }
    }
    return false;
...
static bool is_already_loaded(HMODULE hDLL)
{
    ...
    if (EnumProcessModules(GetCurrentProcess(), hModules, sizeof(hModules), &cb_needed)) {
        ...
        for (int i=0; i<cb_needed/sizeof(HMODULE); i++) {
            ...
            if (filename && wcsicmp(filename, L"\\at.dll")==0 && wcsicmp(t, me)!=0) {
                log_(L"another at.dll already loaded from: %s\n", t);
                return true;
            }
        }
    }
...
void at_get_size(char *filename, struct FILE_INFO *fi)
{
...
#include "vshader.h"
    ...
    hr = DX11.Device->CreateVertexShader(g_atVS, sizeof(g_atVS), NULL, &g_pVertexShader);
    if (FAILED(hr)) {
...
#include "vtexshader.h"
    logu_("creating vertex shader from array of %d bytes\n", sizeof(g_atTexVS));
    hr = DX11.Device->CreateVertexShader(g_atTexVS, sizeof(g_atTexVS), NULL, &g_pTexVertexShader);
    if (FAILED(hr)) {
        logu_("DX11.Device->CreateVertexShader failed\n");
        return;
    }
...
#include "pshader.h"
    ...
    hr = DX11.Device->CreatePixelShader(g_atPS, sizeof(g_atPS), NULL, &g_pPixelShader);
    if (FAILED(hr)) {
        logu_("DX11.Device->CreatePixelShader failed\n");
        return;
    }
...
#include "ptexshader.h"
    logu_("creating pixel shader from array of %d bytes\n", sizeof(g_atTexPS));
    hr = DX11.Device->CreatePixelShader(g_atTexPS, sizeof(g_atTexPS), NULL, &g_pTexPixelShader);
    if (FAILED(hr)) {
        logu_("DX11.Device->CreatePixelShader failed\n");
        return;
    }
    ...
    hr = DX11.Device->CreateInputLayout(elements, numElements, g_atVS,
        sizeof(g_atVS), &g_pInputLayout);
    if (FAILED(hr)) {
    ...
    hr = DX11.Device->CreateInputLayout(layout, numElements, g_atTexVS,
        sizeof(g_atTexVS), &g_pTexInputLayout);
    if (FAILED(hr)) {
        logu_("DX11.Device->CreateInputLayout failed\n");
        return;
    }
...
void at_dispatch_show_hide_events(bool on)
{
...
void at_switch_overlay_to_prev_module()
{
    if (_curr_overlay_m != _modules.end()) {
        module_hide(*_curr_overlay_m);
        // previous module
...
void at_switch_overlay_to_next_module()
{
    if (_curr_overlay_m != _modules.end()) {
        module_hide(*_curr_overlay_m);
        // next module
                ...
                if( dwResult == ERROR_SUCCESS ) {
                    ...
                    if (memcmp(&state, &_prev_xi_state, sizeof(xi_state_t))!=0) {
                        ...
                        if (b1==1 && b2==1 && (was_b1!=b1 || was_b2!=b2)) {
                            ...
                            at_dispatch_show_hide_events(_overlay_on);
                            handled = true;
                            ...
                            if (b==0 && was_b!=b) {
                                if (_overlay_on) {
                                    at_switch_overlay_to_next_module();
                                    handled = true;
                                }
                            }
                            else {
                                ...
                                if (b==0 && was_b!=b) {
                                    if (_overlay_on) {
                                        at_switch_overlay_to_prev_module();
                                        handled = true;
                                    }
                                }
                            }
...
bool atVirtualProtect(void *addr, size_t size, DWORD newProt, DWORD *oldProt) {
...
void HookVtblMethod(void *self, int idx, map<BYTE**,BYTE*>* vtables, void *new_func, char *name)
{
    ...
    if ((BYTE*)f == (BYTE*)new_func) {
        ...
        if (atVirtualProtect(vtbl+idx, 8, newProtection, &protection) || (_config->_skip_checks & 0x04)) {
...
void HookVtblMethod2(void *self, int idx, void **old_func, void **old_func2, void *new_func, void *new_func2, char *name)
{
    ...
    if ((BYTE*)f == (BYTE*)new_func) {
        ...
        DWORD protection = 0;
        DWORD newProtection = PAGE_EXECUTE_READWRITE;
        if (atVirtualProtect(vtbl+idx, 8, newProtection, &protection) || (_config->_skip_checks & 0x08)) {
            vtbl[idx] = (BYTE*)new_func;
            f = vtbl[idx];
            logu_("now %s = %p\n", name, f);
        }
    ...
    if (rguid == GUID_SysKeyboard) {
        ...
        HookVtblMethod2(
            *lplpDirectInputDevice, 9,
            ...
            at_GetDeviceStateKeyboard, at_GetDeviceStateGamepad,
        ...
        if (_config->_controller_input_blocking_enabled) {
            HookVtblMethod2(
                *lplpDirectInputDevice, 9,
                ...
                at_GetDeviceStateGamepad, at_GetDeviceStateKeyboard,
                "IDirectInputDevice8::GetDeviceState");
        }
        else {
...
HRESULT at_GetDeviceStateGamepad(IDirectInputDevice8 *self, DWORD cbData, LPVOID lpvData)
{
    DBG(16384) logu_("at_GetDeviceStateGamepad(self:%p): called\n", self);
    ...
    DBG(16384) logu_("at_GetDeviceStateGamepad(self:%p): res = %x\n", self, res);
    return res;
}

HRESULT at_GetDeviceStateKeyboard(IDirectInputDevice8 *self, DWORD cbData, LPVOID lpvData)
{
    DBG(16384) logu_("at_GetDeviceStateKeyboard(self:%p): called\n", self);
    ...
    DBG(16384) logu_("at_GetDeviceStateKeyboard(self:%p): res = %x\n", self, res);
    return res;
}

DWORD at_XInputGetState(DWORD dwUserIndex, XINPUT_STATE *pState)
{
    DBG(16384) logu_("at_XInputGetState(dwUserIndex:%x, pState:%p): called\n", dwUserIndex, pState);
    if (_overlay_on && (_config->_global_block_input || _block_input)) {
        // block input to game
...
void HookXInputGetState()
{
    ...
    if (jmp_xinput_get_state) {
        ...
        if (_xinput_get_state_holder) {
            ...
            DWORD protection;
            DWORD newProtection = PAGE_EXECUTE_READWRITE;
            if (atVirtualProtect(_xinput_get_state_holder, 8, newProtection, &protection) || (_config->_skip_checks & 0x10)) {
                *_xinput_get_state_holder = (BYTE*)at_XInputGetState;
...
HRESULT at_Present(IDXGISwapChain *swapChain, UINT SyncInterval, UINT Flags)
{
    ...
    if (kb_handle == NULL && _config->_overlay_enabled) {
        kb_handle = SetWindowsHookEx(WH_KEYBOARD, at_keyboard_proc, NULL, GetCurrentThreadId());
        logu_("kb_handle = %p\n", kb_handle);
    }
...
static void sendExitMessage() {
    HWND main_hwnd = FindWindow(ATCLS, NULL);
    if (main_hwnd) {
        PostMessage(main_hwnd, AT_MSG_EXIT, 0, 0);
        log_(L"Posted message for AT.exe to quit\n");
    }
}
...
HRESULT at_CreateSwapChain(IDXGIFactory1 *pFactory, IUnknown *pDevice, DXGI_SWAP_CHAIN_DESC *pDesc, IDXGISwapChain **ppSwapChain)
{
    ...
    if ((BYTE*)present == (BYTE*)at_Present) {
        ...
        DWORD protection = 0;
        DWORD newProtection = PAGE_EXECUTE_READWRITE;
        if (atVirtualProtect(vtbl+8, 8, newProtection, &protection) || (_config->_skip_checks & 0x02)) {
            vtbl[8] = (BYTE*)at_Present;
    ...
    LPSECURITY_ATTRIBUTES lpSecurityAttributes, DWORD dwCreationDisposition, DWORD dwFlagsAndAttributes, HANDLE hTemplateFile)
{
    wstring newPath;
    bool changed(false);
    DBG(65536) log_(L"at_CreateFileW:: called for {%s}\n", lpFileName);
    ...
    if (changed) log_(L"at_CreateFileW:: using {%s} --> result: %p\n", lpFileName, result);
    return result;
}
...
BOOL at_MoveFileExW(LPCWSTR lpExistingFileName, LPCWSTR lpNewFileName, DWORD dwFlags)
{
    ...
    wstring newPathTo;
    bool changed(false);
    DBG(65536) log_(L"at_MoveFileExW:: called for {%s}\n", lpExistingFileName);
    if (!_config->_save_folder.empty()) {
    ...
    if (changed) log_(L"at_MoveFileExW:: moving {%s} to {%s} --> result: %d\n", lpExistingFileName, lpNewFileName, result);
    return result;
}
...
BOOL at_DeleteFileW(LPCWSTR lpFileName)
{
    wstring newPath;
    bool changed(false);
    DBG(65536) log_(L"at_DeleteFileW:: called for {%s}\n", lpFileName);
    if (!_config->_save_folder.empty()) {
        wchar_t *p = wcsrchr((wchar_t*)lpFileName, L'\\');
        if (p) {
            wchar_t *filename = p+1;
    ...
    if (changed) log_(L"at_DeleteFileW:: deleting {%s} --> result: %d\n", lpFileName, result);
    return result;
}
...
HANDLE at_FindFirstFileW(LPCWSTR lpFileName, LPWIN32_FIND_DATAW lpFindFileData)
{
    wstring newPath;
    bool changed(false);
    DBG(65536) log_(L"at_FindFirstFileW:: called for {%s}\n", lpFileName);
    if (!_config->_save_folder.empty()) {
        wchar_t *p = wcsrchr((wchar_t*)lpFileName, L'\\');
        if (p) {
            wchar_t *filename = p+1;
    ...
    if (changed) log_(L"at_FindFirstFileW:: using {%s} --> result: %p\n", lpFileName, result);
    return result;
}
...
DWORD at_GetFileAttributesW(LPCWSTR lpFileName)
{
    wstring newPath;
    bool changed(false);
    DBG(65536) log_(L"at_GetFileAttributesW:: called for {%s}\n", lpFileName);
    if (!_config->_save_folder.empty()) {
        wchar_t *p = wcsrchr((wchar_t*)lpFileName, L'\\');
        if (p) {
            wchar_t *filename = p+1;
    ...
    if (changed) log_(L"at_GetFileAttributesW:: using {%s} --> result: %04x\n", lpFileName, result);
    return result;
}
...
HRESULT at_CreateDXGIFactory1(REFIID riid, void **ppFactory)
{
    ...
    if ((BYTE*)sc == (BYTE*)at_CreateSwapChain) {
        ...
        DWORD protection = 0;
        DWORD newProtection = PAGE_EXECUTE_READWRITE;
        if (atVirtualProtect(vtbl+10, 8, newProtection, &protection) || (_config->_skip_checks & 0x01)) {
            vtbl[10] = (BYTE*)at_CreateSwapChain;
...
void at_mem_copy(BYTE *dst, LONGLONG dst_len, BYTE *src, LONGLONG src_len, BYTE **rsp)
{
    HANDLE handle = INVALID_HANDLE_VALUE;
...
void at_lookup_file(LONGLONG p1, LONGLONG p2, char *filename)
{
...
void at_set_settings(STAD_STRUCT *dest_ss, STAD_STRUCT *src_ss)
{
...
DWORD at_trophy_check(DWORD trophy_id)
{
    DWORD tid = trophy_id;
...
void at_custom_event(uint16_t event_id, REGISTERS *regs) {
    if (_config->_lua_enabled) {
        // lua callbacks
        vector<module_t*>::iterator i;
        for (i = _modules.begin(); i != _modules.end(); i++) {
...
void at_goal_scored(DWORD player_id, DWORD player_offset, DWORD is_away_team_goal, BYTE *player_info) {
...
void at_free_select(BYTE *controller_restriction)
{
    *controller_restriction = 0;
}

void at_trophy_table(TROPHY_TABLE_ENTRY *tt)
{
...
char* at_ball_name(char *ball_name)
{
    if (_config->_lua_enabled) {
        // lua callbacks
        vector<module_t*>::iterator i;
...
char* at_stadium_name(STAD_INFO_STRUCT *stad_info, LONGLONG rdx, LONGLONG ptr, SCHEDULE_ENTRY *se)
{
    if (_config->_lua_enabled) {
...
STAD_INFO_STRUCT* at_def_stadium_name(DWORD stadium_id)
{
    logu_("at_def_stadium_name:: called for %d\n", stadium_id);
...
void at_set_stadium_choice(MATCH_INFO_STRUCT *mi, WORD stadium_choice)
{
...
DWORD at_data_ready(FILE_LOAD_INFO *fli)
{
    if (!fli) {
        DBG(1024) logu_("at_data_ready:: WARN: fli is NULL\n");
        return 0;
    }
    char *filename  = *(char**)((BYTE*)fli + 0x148);
    if (!filename) {
        DBG(1024) logu_("at_data_ready:: WARN: filename is NULL\n");
        return 0;
    }
    LONGLONG base_offset_in_cpk  = *(LONGLONG*)((BYTE*)fli +  0x168);
    LONGLONG offs = fli->offset_in_cpk - base_offset_in_cpk;
    DBG(1024) logu_("at_data_ready:: {%s}, {CPK:%s}, buffer=%p, size=0x%x, total=0x%x, sofar=0x%x, bsize=0x%x, offs=0x%x, type=%d\n",
...
void at_kit_status(KIT_STATUS_INFO *ksi, TASK_UNIFORM_IMPL *tu_impl)
{
    _ksi = ksi;
    logu_("at_kit_status: ksi=%p, tu_impl=%p\n", ksi, tu_impl);
    if (ksi) {
        logu_("at_kit_status: ksi->home=%d, ksi->away=%d\n",
            decode_team_id(_ksi->home_team_id_encoded),
            decode_team_id(_ksi->away_team_id_encoded)
        );
        logu_("at_kit_status: tu_impl->home=%d, tu_impl->away=%d\n",
            decode_team_id(tu_impl->home_team_id_encoded),
            decode_team_id(tu_impl->away_team_id_encoded)
        );
        logu_("at_kit_status: is_edit_mode=%d\n", ksi->is_edit_mode);
    }
}

void at_set_team_for_kits(KIT_STATUS_INFO *ksi, DWORD team_id_encoded, LONGLONG r8, DWORD *which)
{
    logu_("at_set_team_for_kits: ksi=%p, which=%p\n", ksi, which);
    if (ksi && which) {
        if (which == &(ksi->home_team_id_encoded)) {
            logu_("at_set_team_for_kits: home=%d, is_edit_mode=%d\n", decode_team_id(team_id_encoded), ksi->is_edit_mode);
            if (ksi->is_edit_mode) {
            ...
            logu_("at_set_team_for_kits: away=%d, is_edit_mode=%d\n", decode_team_id(team_id_encoded), ksi->is_edit_mode);
...
BYTE* at_loaded_uniparam(BYTE* uniparam)
{
...
void at_clear_sc(SCOREBOARD_INFO *sci)
{
    lock_t lock(&_cs);
...
void at_check_kit_choice(MATCH_INFO_STRUCT *mi, DWORD home_or_away)
{
...
static int at_context_get_current_team_id(lua_State *L)
{
    if (!_ksi) {
...
static int at_context_get_current_kit_id(lua_State *L)
{
    int home_or_away = luaL_checkinteger(L, 1);
    if (_mi) {
        lua_pop(L, 1);
...
static int at_context_set_current_kit_id(lua_State *L)
{
    if (!_mi) {
...
static int at_context_get_kit(lua_State *L)
{
...
static int at_context_get_gk_kit(lua_State *L)
{
    int team_id = luaL_checkinteger(L, 1);
...
static int at_context_set_kit(lua_State *L)
{
    int team_id = luaL_checkinteger(L, 1);
    int kit_id = luaL_checkinteger(L, 2);
    if (kit_id > 9) { kit_id = 9; }
...
static int at_context_set_gk_kit(lua_State *L)
{
    int team_id = luaL_checkinteger(L, 1);
...
/**
static int at_context_get_shirt_colors(lua_State *L)
{
...
static int at_context_set_shirt_colors(lua_State *L)
{
    if (!lua_isuserdata(L, 1)) {
        lua_pop(L, lua_gettop(L));
        lua_pushstring(L, "first argument must be a lightuserdata pointer to team-info");
...
static int at_context_refresh_kit(lua_State *L)
{
    logu_("refresh_kit:: ~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
...
static int at_input_is_blocked(lua_State *L)
{
...
static int at_input_set_blocked(lua_State *L)
{
    int val = 0;
    if (lua_gettop(L) > 0) {
...
static uint16_t get_event_id_for_name(const char *s) {
    unordered_map<string,uint16_t>::iterator it = _custom_event_ids.find(s);
    if (it == _custom_event_ids.end()) {
        uint16_t event_id = _next_custom_event++;
        _custom_event_ids.insert(pair<string,uint16_t>(s, event_id));
        return event_id;
    }
    return it->second;
}

static int at_context_register(lua_State *L)
{
    ...
    */
        ...
        if (_curr_m->custom_events == NULL) {
            ...
            custom_event_t *p = _curr_m->custom_events;
...
static int at_context_get_event_id(lua_State *L)
{
    const char *event_key = luaL_checkstring(L, 1);
    lua_pop(L, 1);
    uint16_t event_id = get_event_id_for_name(event_key);
...
static void push_context_table(lua_State *L)
{
    ...
    char *sdir = (char*)Utf8::unicodeToUtf8(at_dir);
    lua_pushstring(L, sdir);
    Utf8::free(sdir);
    lua_setfield(L, -2, "at_dir");

    lua_pushcfunction(L, at_context_register);
    lua_setfield(L, -2, "register");

    lua_pushcfunction(L, at_context_get_event_id);
    lua_setfield(L, -2, "get_event_id");

    lua_pushlightuserdata(L, (void*)at_custom_event_rbx_hk);
    lua_setfield(L, -2, "custom_evt_rbx");

    // ctx.kits
    lua_newtable(L);
    lua_pushcfunction(L, at_context_get_current_team_id);
    lua_setfield(L, -2, "get_current_team");
    lua_pushcfunction(L, at_context_get_current_kit_id);
    lua_setfield(L, -2, "get_current_kit_id");
    lua_pushcfunction(L, at_context_get_kit);
    lua_setfield(L, -2, "get");
    lua_pushcfunction(L, at_context_get_gk_kit);
    lua_setfield(L, -2, "get_gk");
    lua_pushcfunction(L, at_context_set_current_kit_id);
    lua_setfield(L, -2, "set_current_kit_id");
    lua_pushcfunction(L, at_context_set_kit);
    lua_setfield(L, -2, "set");
    lua_pushcfunction(L, at_context_set_gk_kit);
    lua_setfield(L, -2, "set_gk");
    //lua_pushcfunction(L, at_context_set_shirt_colors);
    //lua_setfield(L, -2, "set_shirt_colors");
    //lua_pushcfunction(L, at_context_get_shirt_colors);
    //lua_setfield(L, -2, "get_shirt_colors");
    lua_pushcfunction(L, at_context_refresh_kit);
...
static void push_env_table(lua_State *L, module_t *m)
{
    ...
    */
    ...
    lua_pushvalue(L, -2);  // upvalue for at_log C-function
    lua_pushcclosure(L, at_log, 1);
    lua_settable(L, -3);
    ...
    lua_pushcclosure(L, at_input_is_blocked, 1);
    lua_setfield(L, -2, "is_blocked");
    lua_pushlightuserdata(L, m);
    lua_pushcclosure(L, at_input_set_blocked, 1);
...
static int at_kmp_search(lua_State *L) {
    size_t pattern_len;
    ...
    //logu_("at_kmp_search: pattern=%p, pattern_len=%d, frm=%p, to=%p\n", pattern, pattern_len, frm, to);
    const char *res = kmp_search(pattern, pattern_len, frm, to);
    //logu_("at_kmp_search: res=%p\n", res);
    lua_pop(L, lua_gettop(L));
    if (res) {
...
void init_lua_support()
{
    if (_config->_lua_enabled) {
        ...
        lua_pushcclosure(L, at_match_get_stats, 1);
        lua_settable(L, -3);
        _match_lib_index = lua_gettop(L);

        // kmp_search function
        lua_pushcfunction(L, at_kmp_search);
        lua_setglobal(L, "at_kmp_search");
...
#define NUM_PATTERNS 47
    ...
    frag_len[13] = _config->_free_side_select ? sizeof(pattern_at)-1 : 0;
    ...
    log_(L"AT initialization complete.\n");
    return 0;
}
...
bool hook_if_all_found() {
    ...
    if (all_found(_config)) {
        logu_("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
        logu_("Success:: all hook points found. AT is enabled now\n");
        logu_("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
        result = true;

        // hooks
        if (_config->_livecpk_enabled) {
            log_(L"at_read_file_hk: %p\n", at_read_file_hk);
            log_(L"at_get_size_hk: %p\n", at_get_size_hk);
            log_(L"at_extend_cpk_hk: %p\n", at_extend_cpk_hk);
            log_(L"at_mem_copy_hk: %p\n", at_mem_copy_hk);
            log_(L"at_lookup_file: %p\n", at_lookup_file_hk);

            hook_indirect_call(_config->_hp_at_read_file, (BYTE*)at_read_file_hk);
            hook_call(_config->_hp_at_get_size, (BYTE*)at_get_size_hk, 0);
            hook_call(_config->_hp_at_extend_cpk, (BYTE*)at_extend_cpk_hk, 1);
            hook_call(_config->_hp_at_mem_copy, (BYTE*)at_mem_copy_hk, 0);
            hook_call_rcx(_config->_hp_at_lookup_file, (BYTE*)at_lookup_file_hk, 3);
        }
        ...
        if (_config->_hp_at_dxgi) {
            ...
            hook_indirect_call(addr, (BYTE*)at_CreateDXGIFactory1);
        }
        if (_config->_hp_at_createfilew) {
            hook_indirect_call(_config->_hp_at_createfilew, (BYTE*)at_CreateFileW);
        }
        if (_config->_hp_at_movefileexw) {
            hook_indirect_call(_config->_hp_at_movefileexw, (BYTE*)at_MoveFileExW);
        }
        if (_config->_hp_at_deletefilew) {
            hook_indirect_call(_config->_hp_at_deletefilew, (BYTE*)at_DeleteFileW);
        }
        if (_config->_hp_at_getfileattributesw) {
            hook_indirect_call(_config->_hp_at_getfileattributesw, (BYTE*)at_GetFileAttributesW);
        }
        if (_config->_hp_at_findfirstfilew) {
            hook_indirect_call(_config->_hp_at_findfirstfilew, (BYTE*)at_FindFirstFileW);
        }
        ...
        if (_config->_lua_enabled) {
            ...
            log_(L"at_trophy_table: %p\n", at_trophy_table_hk);
            log_(L"at_context_reset: %p\n", at_context_reset_hk);
            log_(L"at_ball_name: %p\n", at_ball_name_hk);
            log_(L"at_stadium_name: %p\n", at_stadium_name_hk);
            log_(L"at_def_stadium_name: %p\n", at_def_stadium_name_hk);
            log_(L"at_set_stadium_choice: %p\n", at_set_stadium_choice_hk);
            log_(L"at_check_kit_choice: %p\n", at_check_kit_choice_hk);
            log_(L"at_data_ready: %p\n", at_data_ready_hk);
            log_(L"call_to_move at: %p\n", _config->_hp_at_call_to_move);
            log_(L"at_custom_event_rbx_hk: %p\n", at_custom_event_rbx_hk);
            log_(L"at_goal_scored_hk: %p\n", at_goal_scored_hk);
            ...
            if (_config->_hp_at_set_settings)
                hook_call_with_head_and_tail(_config->_hp_at_set_settings, (BYTE*)at_set_settings_hk,
            ...
            if (_config->_hp_at_trophy_check)
                hook_call_rcx(_config->_hp_at_trophy_check, (BYTE*)at_trophy_check_hk, 0);
            if (_config->_hp_at_trophy_check2)
                hook_call_rcx(_config->_hp_at_trophy_check2, (BYTE*)at_trophy_check2_hk, 0);
            if (_config->_hp_at_trophy_table)
                hook_call_rcx(_config->_hp_at_trophy_table, (BYTE*)at_trophy_table_hk, 0);
            if (_config->_hook_context_reset)
                hook_call(_config->_hp_at_context_reset, (BYTE*)at_context_reset_hk, 6);

            if (_config->_hp_at_ball_name) {
                hook_call_with_head_and_tail(_config->_hp_at_ball_name, (BYTE*)at_ball_name_hk,
                ...
                logu_("WARN: This looks to be PES Lite. Some at features will not work\n");
            }

            hook_call_with_head_and_tail(_config->_hp_at_stadium_name, (BYTE*)at_stadium_name_hk,
            ...
            if (call_target) {
                hook_jmp(call_target, (BYTE*)at_set_stadium_choice_hk, 0);
            }
            //hook_call_with_head_and_tail(_config->_hp_at_set_stadium_choice, (BYTE*)at_set_stadium_choice_hk,
            ...
            hook_jmp(_config->_hp_at_data_ready, (BYTE*)at_data_ready_hk, 0);

            hook_call(_config->_hp_at_check_kit_choice, (BYTE*)at_check_kit_choice_hk, 0);

            _uniparam_base = get_target_location2(_config->_hp_at_get_uniparam);
            log_(L"_uniparam_base = %p\n", _uniparam_base);

            hook_call_rdx(_config->_hp_at_kit_status, (BYTE*)at_kit_status_hk, 2);

            hook_call_rcx(_config->_hp_at_set_team_for_kits, (BYTE*)at_set_team_for_kits_hk, 1);
            hook_call(_config->_hp_at_clear_team_for_kits, (BYTE*)at_clear_team_for_kits_hk, 4);
            hook_call_rdx(_config->_hp_at_uniparam_loaded, (BYTE*)at_loaded_uniparam_hk, 0);
            if (_config->_match_stats_enabled) {
                hook_call(_config->_hp_at_copy_clock, (BYTE*)at_copy_clock_hk, 6);
                hook_call(_config->_hp_at_clear_sc, (BYTE*)at_clear_sc_hk, 2);
            }
            ...
            hook_call_rdx_with_head_and_tail_and_moved_call(
                _config->_hp_at_def_stadium_name, (BYTE*)at_def_stadium_name_hk,
            ...
            if (_config->_hp_at_set_edit_team_id) {
                hook_call(_config->_hp_at_set_edit_team_id, (BYTE*)at_set_edit_team_id_hk, 3);
            }
            ...
            DWORD oldProt;
            if (atVirtualProtect(_config->_hp_at_goal_scored, 4, PAGE_EXECUTE_READWRITE, &oldProt)) {
                memcpy(_config->_hp_at_goal_scored, &offset, 4);
                hook_call_with_tail(calltarget, (BYTE*)at_goal_scored_hk, goal_scored_tail, 2);
            }
            else {
        ...
        if (_config->_free_side_select) {
            log_(L"at_free_select: %p\n", at_free_select_hk);
            hook_call_rcx(_config->_hp_at_at, (BYTE*)at_free_select_hk, 0);
        }
...
void init_direct_input()
{
    ...
    if (SUCCEEDED(DirectInput8Create(
        ...
        // hook CreateDevice
        HookVtblMethod2(g_IDirectInput8, 3, (void**)&_org_CreateDevice, NULL, at_CreateDevice, NULL, "IDirectInput8::CreateDevice");
    }
    else {
...
void enumerate_controllers()
{
    ...
    if (SUCCEEDED(g_IDirectInput8->EnumDevices(
        DI8DEVCLASS_GAMECTRL, at_device_enum_callback, NULL, DIEDFL_ALLDEVICES))) {
        ...
        if (_has_controller) {
            ...
            if (SUCCEEDED(g_IDirectInput8->CreateDevice(
                ...
                if (SUCCEEDED(g_IDirectInputDevice8->EnumObjects(
                    at_object_enum_callback, NULL, DIDFT_PSHBUTTON | DIDFT_AXIS | DIDFT_POV))) {
    ...
    switch(Reason) {
        ...
        case DLL_PROCESS_DETACH:
            ...
            if (_is_game) {
                ...
                // tell at.exe to close
                if (_ok_to_exit) {
                    if (_config->_close_at_on_exit || !_config->_start_game.empty()) {
                        sendExitMessage();
                    }
                }
                DeleteCriticalSection(&_cs);
...
LRESULT CALLBACK at_keyboard_proc(int code, WPARAM wParam, LPARAM lParam)
{
    ...
    if (code == HC_ACTION) {
        ...
        if (_overlay_on) {
            //logu_("at_keyboard_proc: wParam=%p, lParam=%p\n", wParam, lParam);
...
void setHook1()
{
    handle1 = SetWindowsHookEx(WH_FOREGROUNDIDLE, at_foreground_idle_proc, myHDLL, GetCurrentThreadId());
    log_(L"handle1 = %p\n", handle1);
}
