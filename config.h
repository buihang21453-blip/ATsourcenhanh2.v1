...
extern wchar_t at_dir[MAX_PATH];
...
public:
                 ...
                 _num_minutes(0)
    {
        ...
        _close_at_on_exit = GetPrivateProfileInt(_section_name.c_str(),
            L"close.on.exit", _close_at_on_exit,
            config_ini);
