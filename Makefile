...
at.res: at.rc
	$(RC) -r -fo at.res at.rc
at_main.res: at_main.rc at.ico
	$(RC) -r -fo at_main.res at_main.rc

simple_playback.obj: simple_playback.c
audio.obj: audio.cpp audio.h at.h common.h config.h
...
vshader.h: vshader.hlsl
	fxc /E atVS /Ges /T vs_4_0 /Fh vshader.h vshader.hlsl

vtexshader.h: vtexshader.hlsl
	fxc /E atTexVS /Ges /T vs_4_0 /Fh vtexshader.h vtexshader.hlsl

pshader.h: pshader.hlsl
	fxc /E atPS /Ges /T ps_4_0 /Fh pshader.h pshader.hlsl

ptexshader.h: ptexshader.hlsl
	fxc /E atTexPS /Ges /T ps_4_0 /Fh ptexshader.h ptexshader.hlsl

at.obj: at.cpp at.h patterns.h common.h config.h audio.h imageutil.h vshader.h vtexshader.h pshader.h ptexshader.h libz.h kitinfo.h utf8.h regs.h
at.dll: at.obj util.obj imageutil.obj version.obj common.obj kmp.obj memlib.obj fslib.obj libz.obj audio.obj kitinfo.obj DDSTextureLoader.obj WICTextureLoader.obj regs.obj at.res $(LUALIBPATH)\$(LUALIB) $(FW1LIBPATH)\$(FW1LIB) $(LPZLIB)\$(ZLIBLIB)
	$(LINK) $(LFLAGS) /out:at.dll /DLL at.obj util.obj imageutil.obj version.obj common.obj kmp.obj memlib.obj fslib.obj libz.obj audio.obj kitinfo.obj DDSTextureLoader.obj WICTextureLoader.obj regs.obj at.res $(ZLIBLIB) /LIBPATH:$(LUALIBPATH) /LIBPATH:$(FW1LIBPATH) $(LIBS) $(LUALIB) $(FW1LIB) /LIBPATH:$(LPZLIB) /LIBPATH:"$(LIB)"

AT.exe: main.obj at.dll at_main.res
	$(LINK) $(LFLAGS) /out:AT.exe main.obj at_main.res $(LIBS) at.lib /LIBPATH:"$(LIB)"
