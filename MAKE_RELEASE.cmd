...
copy /y HUONG_DAN_NHANH2_SETTEAM_v1.3.2.txt "%OUT%\HUONG_DAN_NHANH2_SETTEAM_v1.3.2.txt" >nul

> "%OUT%\HUONG_DAN.txt" echo PES ARENA - NHANH 2 SET TEAM v1.3.2 - CORE HOOK TEST
...
>>"%OUT%\HUONG_DAN.txt" echo 6. enabled=1 de ep Home/Away tai hook loi at_set_team_id.
>>"%OUT%\HUONG_DAN.txt" echo 7. Log can co: NHANH2 SET TEAM v1.3.2 CORE_FORCE va VERIFY.
>>"%OUT%\HUONG_DAN.txt" echo.
